...
public class ForceField : MonoBehaviour
{
	...
	public void CreateForceField()
	{
		...
		else
		{
			...
			sp = GameObject.Instantiate(Resources.Load<GameObject>("Prefabs/newShield1"));
			sp.name = "ForceField";
			...
			DetectHit detectHit = sp.GetComponent<DetectHit>();
			detectHit.forceField = this;
			//MeshCollider mc = sp.AddComponent<MeshCollider>();
			//mc.convex = true;
			//mc.isTrigger = true;
		}
